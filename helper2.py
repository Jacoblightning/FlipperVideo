...
parser.add_argument('-q', '--quiet',
                    action='store_true',
                    help="don't output info to stdout")
...
frame_count = fraction_half_round_up(source_frame_count * frame_rate / source_frame_rate)
...
if not args.quiet:
    ...
    if frame_count > source_frame_count:
        print(f"warning: {frame_count - source_frame_count:d} frames will be duplicated\n")
    ...
    if (sample_rate / frame_rate).denominator != 1:
        ...
        print("warning: sample rate is not cleanly divisible by frame rate, this may result in a (usually imperceptible) desync\n")
